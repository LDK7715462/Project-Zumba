...
<body class="bg-gray-100">
    <svg class="fixed bottom-0 h-auto z-[-1] w-full" id="visual" viewBox="0 0 960 540" width="960" height="540"
    ...
    if (is_user_logged_in()) {
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            ...
            ?>
            <div class="flex justify-center px-10 py-20">
                <div class="w-[30rem] rounded-lg shadow-lg p-10 backdrop-blur-lg bg-white/40">
                    <h2 class="text-2xl text-left font-bold mb-4 text-teal-900">Welcome,
                        <?php echo $first_name; ?>!
                    </h2>
